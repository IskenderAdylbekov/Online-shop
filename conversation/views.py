...
@login_required
def new_conversation(request, item_pk, slug):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("detail", id=item_pk, slug=slug)
    else:
...
def detail(request, id, slug):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect("conversation:detail", id=id, slug=slug)
    else:
        form = ConversationMessageForm()
